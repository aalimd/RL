        ...
        <div class="card-body">
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 1rem;">
                        <label style="font-size: 0.75rem; color: #9ca3af;">Verification Token</label>
            ...
            @if($request->custom_content)
                <div style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid #e5e7eb;">
                    <h4 style="font-size: 0.875rem; text-transform: uppercase; color: #6b7280; margin-bottom: 1rem;">Custom
                        Content / Notes</h4>
            ...
            <div style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid #e5e7eb;">
                ...
                <form method="POST" action="{{ route('admin.requests.update-status', $request->id) }}"
                    ...
                    <div style="flex: 1; min-width: 250px;">
                        <label
                            style="display: block; font-size: 0.875rem; margin-bottom: 0.5rem; color: #374151; font-weight: 500;">Admin
                            Message (Optional)</label>
                        <textarea name="admin_message" rows="1"
                            style="width: 100%; padding: 0.5rem 1rem; border: 1px solid #d1d5db; border-radius: 0.5rem; min-height: 42px; height: 42px; line-height: 1.5;"
            ...
            <div style="padding: 1.5rem;">
                <form method="POST" action="{{ route('admin.requests.update', $request->id) }}">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem;">
                        <div style="margin-bottom: 1rem;">
                            <label
                                ...
                                Name *</label>
                            <input type="text" name="student_name" value="{{ $request->student_name }}" required
                        ...
                        <div style="margin-bottom: 1rem;">
                            <label
                                style="display: block; font-size: 0.875rem; margin-bottom: 0.5rem; font-weight: 500;">Deadline</label>
                        ...
                        <div style="margin-bottom: 1rem;">
                            <label
                                style="display: block; font-size: 0.875rem; margin-bottom: 0.5rem; font-weight: 500;">Purpose</label>
                            <select name="purpose"
                                style="width: 100%; padding: 0.5rem 1rem; border: 1px solid #d1d5db; border-radius: 0.5rem;">
                    ...
                    <div style="margin-bottom: 1rem;">
                        ...
                        <textarea name="custom_content" id="customContentField" rows="6"
                            style="width: 100%; padding: 0.5rem 1rem; border: 1px solid #d1d5db; border-radius: 0.5rem;"
